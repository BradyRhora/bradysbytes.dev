export class BBFileSystem {
    ...
    initFiles() {
        ...
        new BBFile("gone_fishing.gam", games, `{"title":"Gone Fishing","description":"Catch fish, earn money, and go deeper and deeper in this cute fishing game.","imagePath":"/game_covers/gone_fishing.png", "url":"https://matthewi.itch.io/gone-fishing"}`);
