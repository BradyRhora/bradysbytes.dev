/*
  ...
  - Added the required column `scheduleIndex` to the `UserPerformance` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_UserPerformance" ("createdAt", "id", "skipsUsed", "success", "userId") SELECT "createdAt", "id", "skipsUsed", "success", "userId" FROM "UserPerformance";
